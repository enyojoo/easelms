...
# Website URL for CORS (set to your website domain)
...
curl https://your-website.com/api/courses/1
```
...
**4. Course Detail 400 Error:**
- Check that course URLs use proper slugs (e.g., `/courses/course-title-123`)
- Verify LMS can handle both slug and ID formats

**5. Enrollment Redirects Failing:**
