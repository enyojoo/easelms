    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8">{platformName} Terms of Service</h1>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2 text-base md:text-lg">
          ...
          <section className="mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-4">3. User Accounts</h2>
            <p className="text-base md:text-lg mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-4">4. Course Content</h2>
            <p className="text-base md:text-lg mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-4">5. Payment and Refunds</h2>
            <p className="text-base md:text-lg mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-4">6. Prohibited Uses</h2>
            <p className="text-base md:text-lg mb-4">You may not use our Service:</p>
            <ul className="list-disc pl-6 mb-4 space-y-2 text-base md:text-lg">
          ...
          <section className="mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-4">7. Termination</h2>
            <p className="text-base md:text-lg mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-4">9. Governing Law</h2>
            <p className="text-base md:text-lg mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-4">10. Changes to Terms</h2>
            <p className="text-base md:text-lg mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-4">11. Contact Information</h2>
            <p className="text-base md:text-lg mb-4">
