    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8">{platformName} Privacy Policy</h1>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl md:text-2xl font-semibold mb-2">Personal Information</h3>
            <ul className="list-disc pl-6 mb-4 space-y-1 text-base md:text-lg">
            ...
            <h3 className="text-xl md:text-2xl font-semibold mb-2">Usage Information</h3>
            <ul className="list-disc pl-6 mb-4 space-y-1 text-base md:text-lg">
          ...
          <section className="mb-8">
            ...
            <p className="text-base md:text-lg mb-4">We use the information we collect to:</p>
            <ul className="list-disc pl-6 mb-4 space-y-1 text-base md:text-lg">
          ...
          <section className="mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-4">3. Information Sharing</h2>
            <p className="text-base md:text-lg mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-4">4. Data Security</h2>
            <p className="text-base md:text-lg mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-4">5. Cookies and Tracking</h2>
            <p className="text-base md:text-lg mb-4">
              We use cookies and similar technologies to enhance your experience on our platform.
            </p>
            <h3 className="text-xl md:text-2xl font-semibold mb-2">Types of Cookies We Use</h3>
            <ul className="list-disc pl-6 mb-4 space-y-1 text-base md:text-lg">
          ...
          <section className="mb-8">
            ...
            <p className="text-base md:text-lg mb-4">You have the following rights regarding your personal information:</p>
            <ul className="list-disc pl-6 mb-4 space-y-1 text-base md:text-lg">
          ...
          <section className="mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-4">7. Data Retention</h2>
            <p className="text-base md:text-lg mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-4">8. International Data Transfers</h2>
            <p className="text-base md:text-lg mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-4">9. Children's Privacy</h2>
            <p className="text-base md:text-lg mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-4">10. Third-Party Services</h2>
            <p className="text-base md:text-lg mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-4">11. Changes to This Policy</h2>
            <p className="text-base md:text-lg mb-4">
