...
export default function VideoPlayer({
  ...
  // Load saved progress
  useEffect(() => {
    if (!videoProgression || !progressStorageKey || !videoUrl) return
  ...
  }, [videoProgression, progressStorageKey, lessonId, videoUrl])
  ...
  // Cleanup: Pause all videos when lesson changes
  useEffect(() => {
