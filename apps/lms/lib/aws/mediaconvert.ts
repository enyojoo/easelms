 ...
 * Output: courses/course-18/hls/preview-video-123/preview-video-123.m3u8
 * 
 * Note: MediaConvert creates the master playlist using the folder name as the filename
 */
